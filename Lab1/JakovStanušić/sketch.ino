...
// Timer1 compare interrupt funkcija
...
void handleTimerInterrupt() {
  ...
  // Upali timer LED i ispiši poruku
  digitalWrite(LED_Timer, HIGH);
  Serial.println("TIMER INTERRUPT (najveći prioritet)");
  delay(1000);
...
void triggerDistanceAlert()
{
  ...
  digitalWrite(LED_Sensor, LOW);
  delay(200);
  Serial.println("ALARM: <100cm, najmanji prioritet)!");
}
...
void handleInterrupt(int interruptNum)
{
  ...
  case 0:
    ...
    Serial.println("INT0 (Visoki prioritet)");
    int0Flag = false;
    delay(500);
    digitalWrite(LED_INT0, LOW);
    break;
  case 1:
    ...
    Serial.println("INT1 (Srednji prioritet)");
    int1Flag = false;
    delay(500);
    digitalWrite(LED_INT1, LOW);
    break;
  case 2:
    ...
    Serial.println("INT2 (Niski prioritet)");
    int2Flag = false;
    delay(500);
    digitalWrite(LED_INT2, LOW);
    break;
